...
class ImageManager:
    def __init__(self):
        ...
        self.group_images_directories = ['./images/Group/']
    ...
    def extract_faces(self, img, bounds):
        """
        Function takes in an image and bounds list and returns faces
        """
        faces = []
    ...
    def get_group_images(self, color=cv2.COLOR_BGR2RGB):
        group_images = []
